<template>
  ...
  <el-dialog v-model="dialogVisible" title="Add or Edit" width="40%">
  ...
  <el-table :data="list" style="width: 100%">
    ...
    <el-table-column label="Operation" align="center" width="280" #default="scope">
      ...
      <el-dialog v-model="dialogRoleVisible" title="Assign Roles" width="40%">
        <el-form label-width="80px">
          <el-form-item label="UserName">
            <el-input disabled :value="sysUser.userName"></el-input>
          </el-form-item>

          <el-form-item label="Role Category">
...
const allRoles = ref([
  ...
  { id: 2, roleName: 'Business Staff' },
  { id: 3, roleName: 'Product Entry Clerk' },
])
